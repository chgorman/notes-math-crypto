...
data = bytes.fromhex('00'*num_bytes)
words = mnemo.to_mnemonic(data)
seed = Mnemonic.to_seed(words)

print("BIP-39 Mnemonic Seed Phrase; 128-bit entropy, all zeros")
print("#"*72)
print()
print("Data (hex)")
print(data.hex())
...
print()
total_bits = "{:0128b}".format(int(data.hex(),16)) + checksum_str
