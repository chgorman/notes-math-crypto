...
sha3_256.update(dataPre)
data = sha3_256.digest()
words = mnemo.to_mnemonic(data)
seed = Mnemonic.to_seed(words)

print("BIP-39 Mnemonic Seed Phrase; 256-bit entropy, sha3(zeros)")
print("#"*72)
print()
print("Data (hex)")
print(data.hex())
...
print()
total_bits = "{:0256b}".format(int(data.hex(),16)) + checksum_str
